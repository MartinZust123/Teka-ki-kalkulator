...
INSERT INTO Oseba (spol, PriimekInIme, LR, "3.3km", "6.6km", "10km")
...
INSERT INTO Oseba (spol, PriimekInIme, LR, "3km")
...
INSERT INTO Oseba (spol, PriimekInIme, LR, "6km", "10km")
SELECT 'M', "Priimek in ime", "LR", 
...
INSERT INTO Oseba (spol, PriimekInIme, LR, "10km", "17km", "21km")
SELECT 'M', "Priimek in ime", "LR", 
...
INSERT INTO Oseba (spol, PriimekInIme,"5km", "10km")
...
INSERT INTO Oseba (spol, PriimekInIme,"5km", "10km", "15km", "20km", "21km")
SELECT 'M', "Priimek in ime", 
        CASE WHEN "5km" = '&nbsp;' THEN NULL ELSE "5km"::TIME END,
        CASE WHEN "10km" = '&nbsp;' THEN NULL ELSE "10km"::TIME END,
...
INSERT INTO Oseba (spol, PriimekInIme,"5km", "10km", "15km", "20km", "21.1km", "25km", "30km", "35km", "40km", "42km")
SELECT 'M', "Priimek in ime", 
        CASE WHEN "5km" = '&nbsp;' THEN NULL ELSE "5km"::TIME END,
        CASE WHEN "10km" = '&nbsp;' THEN NULL ELSE "10km"::TIME END,
        CASE WHEN "15km" = '&nbsp;' THEN NULL ELSE "15km"::TIME END,
...
INSERT INTO Oseba (spol, PriimekInIme, LR, "2km", "5km")
SELECT 'M', "Priimek in ime", "LR", 
